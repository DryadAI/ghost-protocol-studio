...
- [ ] Per-line TTS preview button in the transcript (voiceprint preview already exists per cast card)
...
- [x] Designed OmniVoice voice per speaker (17 voiceprints, distinctness-verified) + engine switch
